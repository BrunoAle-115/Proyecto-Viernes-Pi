...
class GoogleOAuthManager:
    ...
    def __init__(self, token_path: str = "credentials/gmail_token.json"):
        self.token_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), token_path)
    ...
    def get_authorization_url(self, redirect_uri: str, state: str = "viernes_google_oauth") -> str:
        """Genera la URL de consentimiento para Google OAuth2."""
        client_id = os.getenv("GOOGLE_CLIENT_ID", "607147779361-sample.apps.googleusercontent.com")
        params = {
            "client_id": client_id,
